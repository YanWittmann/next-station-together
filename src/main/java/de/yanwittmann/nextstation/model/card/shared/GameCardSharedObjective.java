...
public class GameCardSharedObjective extends GameCard {
    ...
    public enum CardSymbol {
        ...
        ALL_STATIONS_IN_CENTRAL(TextureAccess.TexturesIndex.CARD_SHARED_OBJECTIVE.get("all_stations_in_central"), "Draw your Underground network such that it connects to all stations in the central district of the city."),
        // paris
